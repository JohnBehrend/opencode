...
import { audioStreamRoute, fileHandlers } from "./handlers/file"
...
const rawInstanceRoutes = Layer.mergeAll(ptyConnectRoute, audioStreamRoute).pipe(Layer.provide(instanceRouterLayer))
